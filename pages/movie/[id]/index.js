  ...
  return (
    ...
    <div className="container max-w-4xl mx-auto pt-6">
      ...
      <div className="px-3">
        ...
        <p className="mt-5 text-gray-300 text-sm">Genres: <span className="font-bold">{movie.genres.map(genre => genre.name).join(', ')}</span></p>
        <p className="text-gray-300 text-sm pb-5">Release Date: <span className="font-bold">{movie.release_date}</span></p>
      </div>
    </div>
    </div>
  );
