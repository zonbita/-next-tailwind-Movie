  ...
  return (
    ...
    <a>
      <div className="bg-white shadow-sm rounded-md cursor-pointer hover:bg-slate-700 w-full h-full">
        <Image src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`}  loading='lazy' layout='responsive' objectFit='fill' width={237} height={271} className="rounded-t-md" alt={movie.title} />
